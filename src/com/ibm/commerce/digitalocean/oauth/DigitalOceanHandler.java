package com.ibm.commerce.digitalocean.oauth;
...
/**
 * Servlet implementation class MobileCallBackHandler
 */
@WebServlet("/DigitalOceanHandler")
public class DigitalOceanHandler extends HttpServlet {
	...
	private static String SERVLET_NAME="DigitalOceanHandler";
	private static String PROPERTIES_FILE = "digitalocean.properties";
	
	
    public DigitalOceanHandler() {
        super();
